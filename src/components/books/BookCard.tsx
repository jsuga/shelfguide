...
const BookCard = ({
  ...
  return (
    <div className="rounded-xl border border-border/60 bg-card/70 p-4 shadow-sm max-w-[92vw] sm:max-w-none">
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h3 className="font-display text-base sm:text-lg font-bold mt-1 line-clamp-2 sm:truncate">{book.title}</h3>
